...
const INITIAL_TOPPINGS = [
  { id: "top-1", name: "Mochi Kéo Dài (Signature Đô Đô)", price: 6000, inStock: true },
  { id: "top-2", name: "Mochi Nếp Lạnh Dẻo", price: 6000, inStock: true },
  { id: "top-3", name: "Kem Tiramisu Phô Mai", price: 8000, inStock: true },
  { id: "top-4", name: "Vụn Bánh Cookies Ovaltine", price: 5000, inStock: true },
  { id: "top-5", name: "Trân Châu Hoàng Kim", price: 5000, inStock: true },
  { id: "top-6", name: "Pudding Trứng Mịn Dẻo", price: 6000, inStock: true },
  { id: "top-7", name: "Thạch Đào Giòn", price: 5000, inStock: true },
  { id: "top-8", name: "Kem Cheese Macchiato", price: 8000, inStock: true }
];
...
const INITIAL_PRODUCTS = [
  ...
  },
  {
    ...
    description: "Socola béo đậm kết hợp vụn bánh cookies nướng giòn rụm và sốt kem Ovaltine ngập tràn topping.",
    isBestseller: false,
    isNew: false,
    inStock: true,
    stockQty: 80
  },
  {
    ...
    sold: 4120,
    image: "https://images.unsplash.com/photo-1558857563-b37fcdd72460?auto=format&fit=crop&w=600&q=80",
    description: "Vị trà sữa nguyên bản Đô Đô thơm nồng đượm vị lá trà, béo ngậy vừa vặn với mức giá bình dân siêu yêu thương chỉ 21K.",
    isBestseller: true,
    isNew: false,
    inStock: true,
    stockQty: 150
  },
  {
    ...
    sold: 2310,
    image: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=600&q=80",
    description: "Trà Oolong nướng than thơm lừng hòa quyện cùng lớp kem phô mai béo mặn sánh mịn.",
    isBestseller: true,
    isNew: false,
    inStock: true,
    stockQty: 80
  ...
  {
    id: "TS-10",
    name: "Trà Sữa Khoai Môn Taro Dẻo",
    category: "tra-sua",
    price: 25000,
    oldPrice: 30000,
    rating: 4.7,
    sold: 1100,
    image: "https://images.unsplash.com/photo-1541658016709-82535e94bc69?auto=format&fit=crop&w=600&q=80",
    description: "Khoai môn dẻo thơm kết hợp nền trà sữa truyền thống thơm bùi sánh ngậy.",
    isBestseller: false,
    isNew: false,
    inStock: true,
    stockQty: 55
